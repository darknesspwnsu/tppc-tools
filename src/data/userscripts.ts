...
(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      "  color: var(--tppc-text) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow {",
      "  color: var(--tppc-text) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow :is(#battleTitle, #MoveBox, #battleText, #battleText li, #cancelBattle, .headerBar, .innerContent, .innerContent fieldset, .innerContent fieldset legend, .rosterContent, .rosterContent li, .item) {",
      "  color: var(--tppc-text) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .headerBar {",
      "  background-color: var(--tppc-current-line) !important;",
      "  border-color: var(--tppc-border) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .innerContent {",
      "  background-color: var(--tppc-surface) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .innerContent fieldset {",
      "  border-color: var(--tppc-border) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .PokeImage {",
      "  background-color: var(--tppc-surface-2) !important;",
      "  border-color: var(--tppc-border) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .rosterContent {",
      "  background-color: var(--tppc-surface) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .rosterContent :is(.row0, .row1) {",
      "  background: transparent !important;",
      "  background-color: transparent !important;",
      "  background-image: none !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .rosterContent :is(.row0, .row1) :is(a, small, span, strong, b, label) {",
      "  color: var(--tppc-text) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .rosterContent .hpBar {",
      "  background-color: var(--tppc-current-line) !important;",
      "  border-color: var(--tppc-border) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .Trainer1 {",
      "  color: var(--tppc-cyan) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow .Trainer2 {",
      "  color: var(--tppc-yellow) !important;",
      "}",
      ":root." + ROOT_CLASS + " #battleWindow :is(select, input.submit, input[type='button'], button) {",
